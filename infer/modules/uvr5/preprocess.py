...
class AudioPre:
    def __init__(self, agg, model_path, device, is_half):
        ...
        mp = ModelParameters(os.path.dirname(os.path.realpath(__file__)) + "/../../lib/uvr5_pack/lib_v5/modelparams/4band_v2.json")
...
class AudioPreDeEcho:
    def __init__(self, agg, model_path, device, is_half):
        ...
        mp = ModelParameters(os.path.dirname(os.path.realpath(__file__)) + "/../../lib/uvr5_pack/lib_v5/modelparams/4band_v3.json")
